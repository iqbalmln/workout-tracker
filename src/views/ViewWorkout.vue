<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
      ...
      >
        <div v-if="user" class="flex absolute left-2 top-2 gap-x-2">
          ...
          <div
            ...
            cursor-pointer bg-at-light-green shadow-lg"
            @click="editMode"
          >
            <img
              class="h-3.5 w-auto"
          ...
          <div
            ...
            cursor-pointer rounded-full bg-at-light-green shadow-lg"
          >
            <img
              class="h-3.5 w-auto"
      ...
      <!-- Exercise -->
      <div
        class="mt-10 p-8 rounded-md flex flex-col items-center bg-light shadow-md"
      >
        <!-- Strenght Training -->
        <div
        ...
        >
          ...
          >
            ...
            <img
              ...
              v-if="edit"
              class="absolute h-4 w-auto -left-4 cursor pointer"
